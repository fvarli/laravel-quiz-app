<x-app-layout>
        ...
        <div class="card-body">
            <form method="post" action="{{ route('quizzes.store') }}">
                ...
                <div class="form-group col-4 offset-4 mt-4">
                    <input type="checkbox" id="isFinsihed"> <label class="mx-2">Is there end date?</label>
                </div>
                <div class="form-group col-4 offset-4 text-center mt-2 d-none datetime">
    ...
    <x-slot name="js">
        <script>
            $('#isFinsihed').change(function (){
                if ($('#isFinsihed').is(':checked')) {
