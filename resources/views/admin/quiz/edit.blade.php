        ...
        <div class="card-body">
            <form method="post" action="{{ route('quizzes.update', $quiz->id) }}">
                ...
                <div class="form-group col-4 offset-4 mt-4">
                    <input @if($quiz->finished_at) checked @endif type="checkbox" id="isFinished"> <label class="mx-2">Is there end date?</label>
                </div>
                <div class="form-group col-4 offset-4 text-center mt-2 @if(!$quiz->finished_at) d-none @endif datetime">
